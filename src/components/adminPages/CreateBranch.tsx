...
import { days, type TGlobalResponse } from "@/types/global.type";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-4">
                <EBInput
                  ...
                  type="text"
                  icon={<Building2 />}
                  className="border-2 border-[#104042] rounded-lg focus:border-[#104042] focus:ring-2 focus:ring-[#104042]/20 transition-all duration-200 px-4 py-2.5 text-sm"
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <EBSelect
                    ...
                    name="city"
                    icon={<MapPin />}
                    className="border-2 border-[#104042] rounded-lg focus:border-[#104042] focus:ring-2 focus:ring-[#104042]/20 transition-all duration-200 px-4 py-2.5 text-sm w-full"
            ...
            <div className="space-y-5">
              ...
              <EBSelectMultiple
                ...
                name="managers"
                icon={<Users />}
                className="border-2 border-[#104042] rounded-lg focus:border-[#104042] focus:ring-2 focus:ring-[#104042]/20 transition-all duration-200"
              />
            </div>
          </div>
